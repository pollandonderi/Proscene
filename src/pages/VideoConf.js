...
import videoConfImage from "../components/assets/sup.jpg";
...
function VideoConferenceRental() {
  ...
  const content = {
    feature1: {
      title: "High-Quality Video and Audio Equipment",
      description: "We provide top-of-the-line video and audio equipment to make your meetings clear and professional, whether it's a team meeting or a global conference.",
      image: supportjpg,
    },
    feature2: {
      title: "Customizable Setup and Configuration",
      description: "We help you configure the perfect setup for your virtual meetings, tailored to your specific needs and the size of your conference room.",
      image: supportjpg,
    },
    feature3: {
      title: "Flexible Rental Plans",
      description: "Our flexible rental plans are designed to fit your business needs and budget, with options for both short-term and long-term rentals.",
    ...
    feature4: {
      ...
      description: "We provide regular maintenance and technical support, ensuring that your equipment always works perfectly during your meetings.",
      image: videoConfImage,
    },
    feature5: {
      title: "Expert Training for Your Team",
      description: "Our team offers training to help you get the most out of your video conferencing equipment, ensuring smooth and effective meetings.",
      image: videoConfImage,
    },
    feature6: {
      title: "Backup Equipment for Peace of Mind",
      description: "We provide backup equipment to minimize the risk of disruptions, ensuring your meetings go smoothly without any technical hitches.",
      image: videoConfImage,
    },
  };
